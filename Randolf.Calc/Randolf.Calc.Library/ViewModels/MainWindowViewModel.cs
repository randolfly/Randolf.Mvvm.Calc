...
using Randolf.Calc.Library.Models;
using Randolf.Calc.Library.Services;
using ReactiveUI;
using ReactiveUI.Fody.Helpers;

namespace Randolf.Calc.Library.ViewModels;
...
public class MainWindowViewModel : ViewModelBase
{
    ...
    [Reactive] public string ShownString { get; set; }

    [Reactive] public string ShownResult { get; set; }
